...
const WorkoutSlider = () => {
  ...
  return <Swiper slidesPerView={2} spaceBetween={32} navigation={true} breakpoints={{768: {slidesPerView:3}, 1024: {slidesPerView:4} }} modules={[Navigation]} className='workoutSlider'>

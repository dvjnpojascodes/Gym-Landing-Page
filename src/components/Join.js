    ...
    <section className='bg-neutral-500 min-h-[537px]'>
      <div className='container mx-auto'>
        <div className=' flex flex-col md:flex-row md:items-center md:-space-x-12 -space-y-24 lg:-space-y-0'>
          {/* image */}
          <div className='-mt-[80px] max-w-[276px] md:max-w-[442px] lg:max-w-full' data-aos="fade-right" data-aos-offset="100" data-aos-delay="100">
            <img src={image} alt=""/>
          </div>

          {/* text */}
          <div className='max-w-[350px] lg:max-w-[530px] ml-[30px]' data-aos="fade-left" data-aos-offset="100" data-aos-delay="100">
            <h2 className='h1 text-white md:text-[60px] md:leading-[62px] mb-4 lg:mb-6'> {title} <span className='text-primary-200'> ?</span></h2>
